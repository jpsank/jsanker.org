...
const Home = () => {
    return (
        <>
            ...
            <Row className="mt-5">
                <Col className="mt-5 d-flex flex-row justify-content-center align-items-center">
                    <h1>CURRENTLY REDESIGNING, PLEASE BEAR WITH</h1>
                    <ConwayCanvas width="512px" height="512px" />
                </Col>
            </Row>
        </>
    );
